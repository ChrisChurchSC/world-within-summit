      ...
      <div className="wf-grid-2" style={{ borderBottom: '1px solid rgba(255,244,226,0.06)' }}>
        ...
        <div className="wf-section--md" style={{ borderRight: '1px solid rgba(255,244,226,0.06)' }}>
          ...
          <p style={{
            ...
            The 2nd Annual World Within Summit returns to our home base in Helena, Montana,
        ...
        <div className="wf-section--md" style={{ background: 'rgba(255,244,226,0.02)' }}>
          ...
          <p style={{
            ...
            Not a conference. A working session for funders and founders moving capital toward
            ownership. 25 seats. Three days. Real work.
          </p>
          ...
          <div className="wf-grid-2" style={{ gap: 'clamp(24px, 5vw, 64px)', alignItems: 'start' }}>
            ...
            <div>
              ...
              <p style={{
                ...
                AFC Wimbledon from scratch. The AFC Wimbledon story is not an anomaly. It is a blueprint.
              </p>
              ...
              <p style={{
                ...
                Produced with the team behind <em>The Last Dance.</em>
              </p>
            </div>
      ...
      <div style={{ borderBottom: '1px solid rgba(255,244,226,0.06)' }}>
        <div className="wf-section--md">
          ...
          <p style={{
            ...
            Wealth reverses direction when capital moves the other way. When enough people see it
            working, a different economy starts to feel inevitable.
          </p>
